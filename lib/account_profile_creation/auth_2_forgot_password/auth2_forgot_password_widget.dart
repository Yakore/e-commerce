        ...
        body: Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [Color(0xFF39C2EF), Color(0xFFEEAC60)],
              stops: [0.0, 1.0],
                          ...
                          children: [
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 8.0, 0.0, 24.0),
                              child: Text(
                                'Rellene su dirección de correo electrónico a continuación para recibir un enlace para restablecer la contraseña.',
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                ...
                                text: 'Mandar Link de Recuperación',
