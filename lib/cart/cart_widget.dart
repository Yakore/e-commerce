                        ...
                        Builder(
                          builder: (context) {
                            ...
                            return ListView.builder(
                              ...
                              shrinkWrap: true,
                              scrollDirection: Axis.vertical,
                              itemCount: itemsSelecionados.length,
                              itemBuilder: (context, itemsSelecionadosIndex) {
                                final itemsSelecionadosItem =
                                    itemsSelecionados[itemsSelecionadosIndex];
                                return StreamBuilder<SelectedItemsRecord>(
                                  stream: SelectedItemsRecord.getDocument(
                                      itemsSelecionadosItem),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
                                    if (!snapshot.hasData) {
                                      return Center(
                                                        ...
                                                        child: RichText(
                                                          ...
                                                          text: TextSpan(
                                                            children: [
                                                              ...
                                                              TextSpan(
                                                                text: columnSelectedItemsRecord
                                                                    .cantidad
                                                                    .toString(),
                                                                style:
                                                                    TextStyle(),
                                              ...
                                              InkWell(
                                                ...
                                                onTap: () async {
                                                            ...
                                                            builder:
                                                              ...
                                                              return AlertDialog(
                                                                title: Text(
                                                                    'Eliminar'),
                                                                content: Text(
                                                                    'Desea Eliminar este Producto del Carrito de Compra?'),
                                                                actions: [
                                                                  TextButton(
                                                                    onPressed: () =>
                                                                        Navigator.pop(
                                                  ...
                                                  if (confirmDialogResponse) {
                                                    ...
                                                    await columnSelectedItemsRecord
                                                        .reference
                                                        .delete();
                                                  }
                                                },
                                  ...
                                  onPressed: () async {
                                    ...
                                    await orderRecordReference.set({
                                      ...
                                      ...mapToFirestore(
                                        {
                                          'selectedItems':
                                              cartCartRecord?.selectedItemsList,
                                        },
                                      ),
                                    });
                                    _model.orden =
