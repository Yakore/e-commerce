...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF228B22);
  late Color tertiary = const Color(0xFFFFD700);
  late Color alternate = const Color(0xFFFF6347);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFF6A00);
  late Color secondary = const Color(0xFF1C7B1C);
  late Color tertiary = const Color(0xFFFFC200);
  late Color alternate = const Color(0xFFFF4835);
  ...
  late Color accent3 = const Color(0xFF7B1FA2);
  late Color accent4 = const Color(0xFFF57C00);
  late Color success = const Color(0xFF388E3C);
  late Color warning = const Color(0xFFFFA000);
  late Color error = const Color(0xFFE64A19);
